...
import com.qa.pages.InpatientManagement_transferrequestpages;

import in.esic.uipackageHIS.LoginPage;
import in.esic.uipackageHIS.StaffLoginPage;

public class InpatientManagement_TransferRequestTest {
  
	
	 WebDriver driver;
	  
     public InpatientManagement_TransferRequestTest(){
	...
	//  driver.manage().timeouts().pageLoadTimeout(50,TimeUnit.SECONDS);
	  ...
	  @Test
	  public void TranferRequestofWard() throws InterruptedException, AWTException {
		...
		InpatientManagement_transferrequestpages output= PageFactory.initElements(driver, InpatientManagement_transferrequestpages.class);
		output.transferrequestwordpress("IP0");
