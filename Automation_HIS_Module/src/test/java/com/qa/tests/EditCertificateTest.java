...
public class EditCertificateTest extends BaseTest {
	...
	@Test(priority = 4)
	public void CheckTheFunctionalityOfRequestForChangedUPdateButton() throws InterruptedException, AWTException {
		Thread.sleep(1000);
		ECP.getEditCertificate_SearchImage().click();
		Thread.sleep(1000);
		utilobj.selectDropdown(ECP.getEditCertificate_Insurance_NO_DLL(), driver, "Starts With");
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		utilobj.selectDropdown(ECP.getEditCertificate_RadioButton_DDLTypeChange(), driver, "Medical Certificate-First");
		Thread.sleep(1000);
		utilobj.selectDropdown(ECP.getEditCertificate_RadioButton_DDLTypeChange(), driver, "Medical Certificate-Intermediate");
		Thread.sleep(1000);
		utilobj.selectDropdown(ECP.getEditCertificate_RadioButton_DDLTypeChange(), driver, "Medical Certificate-Final");
		Thread.sleep(1000);
		utilobj.selectDropdown(ECP.getEditCertificate_RadioButton_DDLTypeChange(), driver, "Medical Certificate-Special Intermediate");
		Thread.sleep(1000);
...
//		utilobj.JSClick(driver.findElement(By.linkText("Edit Maternity Certificate")), driver);
		Thread.sleep(1000);
