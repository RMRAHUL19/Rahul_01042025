...
public class InpatientManagement_WardUnitsTest extends BaseTest {
    ...
    @Test(priority =0)
	  ...
	  @Test(priority = 3)
	  public void WardUnit() throws InterruptedException, AWTException {

		
		
		InpatientManagement_wardunitspages output= PageFactory.initElements(driver, InpatientManagement_wardunitspages.class);
		output.wardunitswordpress("Surgery");
