...
import com.qa.pages.InpatientManagement_intakemasterpages;

import in.esic.uipackageHIS.LoginPage;
import in.esic.uipackageHIS.StaffLoginPage;

public class InpatientManagement_IntakeMasterTest {

	WebDriver driver;
	
	public InpatientManagement_IntakeMasterTest(){
	...
	@Test
	public void InputMaster() throws InterruptedException, AWTException {
		...
		InpatientManagement_intakemasterpages input= PageFactory.initElements(driver, InpatientManagement_intakemasterpages.class);
		input.intakemasterwordpress("test31");
