...
public class OpenVisitPage extends BasePage {
	...
	private By OpenVisitUHID_DLL=By.id("ctl00_cphpage_ucCommonSearch_hisSearchCriteria_dlData_ctl00_ddlCriteria");
	private By OpenVisitUHID_TextBox=By.id("ctl00_cphpage_ucCommonSearch_hisSearchCriteria_dlData_ctl00_txtCriteria");
