...
public class OperationTheatrePage extends BasePage {
	...
	private By UHIDCreation=By.linkText("UHID Creation");
	...
	private By HI_selectitem=By.xpath("/html/body/form/div[3]/div[2]/table/tbody/tr/td/div/div[3]/a[1]");
	...
	public WebElement getUHIDcreationLinkLink() {
		return getElement(UHIDCreation);
	}
