...
public class Emergency_Check_In_RegistrationTest extends CrossBrowser{
	...
	@Parameters("browser")
	    ...
	    Thread.sleep(2000);   
	    utilobj.selectDropdown(ECP.getECRIP_Specialisation_DDL(), driver, "Casualty / Emergency",Browser);
	    Thread.sleep(2000);
	    utilobj.selectDropdown(ECP.getECRIP_Unit_DDL(), driver, "EmergencyUnit", Browser);
	    Thread.sleep(2000);
