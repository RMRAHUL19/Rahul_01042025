...
public class UHIDPage extends BasePage {
	...
	/*
	 * public void doUHIDCreationPage(String Title, String FirstName, String
	 * LastName, String MaritalStatus, String Age, String Address) {
	 * 
	 * try {
	 * 
	 * utilobj.selectDropdown(getTitle(), driver, "Mr."); Thread.sleep(2000);
	 * getFirstName().sendKeys(FirstName); Thread.sleep(2000);
	 * getLastName().sendKeys(LastName);
	 * 
	 * Thread.sleep(2000);
	 * 
	 * System.out.println(MaritalStatus + getMarriageStatus()); Thread.sleep(2000);
	 * utilobj.selectDropdown(getMarriageStatus(), driver, "Single");
	 * Thread.sleep(2000); getAge().sendKeys(Age); Thread.sleep(2000);
	 * getPresentAddres().sendKeys(Address); Thread.sleep(2000);
	 * utilobj.selectDropdown(driver.findElement(By.id(
	 * "ctl00_cphpage_ddlPresentLGDState")), driver, "Maharashtra");
	 * Thread.sleep(20000); utilobj.selectDropdown(driver.findElement(By.id(
	 * "ctl00_cphpage_ddlPresentLGDDistrict")), driver, "Mumbai");
	 * Thread.sleep(20000);
	 * driver.findElement(By.id("ctl00_cphpage_txtPincode")).sendKeys("230532");
	 * Thread.sleep(2000); getSavebutton().click(); Thread.sleep(2000);
	 * getbtnYes().click(); Thread.sleep(2000); getInformationPopUp().click();
	 * Thread.sleep(2000); utilobj.JSClick(getUHID_creation_Uhid_succes(), driver);
	 * //getUHID_creation_Uhid_succes().click(); Thread.sleep(2000);
	 * System.out.println(getUHID_creation_Uhid_txtbox().getText());
	 * Thread.sleep(2000); String
	 * typevalue=getUHID_creation_Uhid_txtbox().getAttribute("value");
	 * Thread.sleep(2000); System.out.println(typevalue); Thread.sleep(2000);
	 * Thread.sleep(2000);//functionility of print button Thread.sleep(2000);
	 * getUHID_creation_printButton().click(); Thread.sleep(2000);
	 * utilobj.SwitchToChildWindow(driver, "RegistrationPrintReports.aspx");
	 * Thread.sleep(2000); driver.manage().window().maximize(); Thread.sleep(2000);
	 * driver.close(); Thread.sleep(2000); utilobj.SwitchToChildWindow(driver,
	 * "Registration"); Thread.sleep(4000);//opd link functionality
	 * getUHID_creation_Uhid_OPDNumber().click(); Thread.sleep(4000);
	 * getpatientCheckInNumberSeviceOkButton().click(); Thread.sleep(4000);
	 * getpatientCheckInNumberSaveButton().click(); Thread.sleep(4000);
	 * getpatientCheckInNumberinfoMsgboxcancelbutton().click(); Thread.sleep(4000);
	 * getpatientCheckInNumberRegistration().click(); Thread.sleep(4000);//clear
	 * button functionelity utilobj.selectDropdown(getTitle(), driver, Title);
	 * Thread.sleep(2000); getFirstName().sendKeys(FirstName); Thread.sleep(2000);
	 * getLastName().sendKeys(LastName);
	 * 
	 * Thread.sleep(2000);
	 * 
	 ...
	 * 
	 * getUHID_creation_clearButton().click(); Thread.sleep(2000); //DUMM.0000013656
	 * getUHID_creation_IMGsearchUhid().click();//uhid search Thread.sleep(2000);
	 * getUHID_creation_UHIDsearchtxtbox().sendKeys(typevalue); Thread.sleep(2000);
	 * getUHID_creation_UHIDButtonsearch().click(); Thread.sleep(2000);
	 * getUHID_creation_UHIDRadiobuttonselect().click(); Thread.sleep(2000);
	 * getUHID_creation_UHIDsearchselect().click(); Thread.sleep(2000);
	 * getUHID_creation_sameaddrescheckbox().click();//update button
	 * Thread.sleep(2000); getUHID_creation_UpdateButton().click();
	 * Thread.sleep(2000); getbtnYes().click();
	 * 
	 * 
	 * Thread.sleep(2000); getUHID_creation_Uhid_succesUpdate().click();
	 * Thread.sleep(3000);
	 * getUHID_creation_InsouranceNOtxtbox().sendKeys("1199900090");//search by ipno
	 * Thread.sleep(2000); getUHID_creation_LivelistLink().click();
	 * Thread.sleep(2000); getUHID_creation_LivelistradioButton().click();
	 * Thread.sleep(2000); getUHID_creation_LivelistSelect().click();
	 * driver.close(); }
	 * 
