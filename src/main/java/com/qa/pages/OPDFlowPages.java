...
public class OPDFlowPages extends BasePage  {
	...
	private By PharmacyIssue = By.xpath("/html/body/div[1]/form/div[3]/div[2]/table/tbody/tr/td[2]/div/div[2]/table/tbody/tr[2]/td/table/tbody/tr/td/div/ul[4]/li[10]/a");
	...
	private By orderpack = By.id("19009");
	...
	private By orderpackselection = By.id("19009"); //
...
private By labotatory_reqno=By.xpath("/html/body/div[1]/form/div[4]/div[2]/div/table/tbody/tr[1]/td/table/tbody/tr[2]/td/div/div/table/tbody/tr[2]/td[1]/a");
	...
	private By cphpage_hyp_0=By.id("ctl00_cphpage_hyp_0");
	public WebElement getcphpage_hyp_0() {
		return getElement(cphpage_hyp_0);
	}
	...
	private By btnclose = By.id("btnClose"); // btnUpdate
	...
	public  void getgenratechekIn() throws InterruptedException {
		...
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofSeconds(30));
		 driver.findElement(By.id("ctl00_cphpage_txtIPNO")).sendKeys("1115104797");
			Thread.sleep(2000);
	...
	private By txtDate=By.id("ctl00_cphpage_OPWorklistSearch_dlData_ctl00_txtDate");
	public WebElement gettxtDate() {
		return getElement(txtDate);
	}
	
	private By txtdate_CalendarExtender_prevArrow=By.id("ctl00_cphpage_OPWorklistSearch_dlData_ctl00_txtdate_CalendarExtender_prevArrow");
	public WebElement gettxtdate_CalendarExtender_prevArrow() {
		return getElement(txtdate_CalendarExtender_prevArrow);
	}
	private By CalendarExtender_day_0_4=By.id("ctl00_cphpage_OPWorklistSearch_dlData_ctl00_txtdate_CalendarExtender_day_0_4");
	public WebElement getCalendarExtender_day_0_4() {
		return getElement(CalendarExtender_day_0_4);
	}
	
	
	private By ctl01_txtDate=By.id("ctl00_cphpage_OPWorklistSearch_dlData_ctl01_txtDate");
	public WebElement getctl01_txtDate() {
		return getElement(ctl01_txtDate);
	}
	
	private By ctl01_txtdate_CalendarExtender_prevArrow=By.id("ctl00_cphpage_OPWorklistSearch_dlData_ctl01_txtdate_CalendarExtender_prevArrow");
	public WebElement getctl01_txtdate_CalendarExtender_prevArrow() {
		return getElement(ctl01_txtdate_CalendarExtender_prevArrow);
	}
	private By ctl01_txtdate_CalendarExtender_day_0_4=By.id("ctl00_cphpage_OPWorklistSearch_dlData_ctl01_txtdate_CalendarExtender_day_0_4");
	public WebElement getctl01_txtdate_CalendarExtender_day_0_4() {
		return getElement(ctl01_txtdate_CalendarExtender_day_0_4);
	}
