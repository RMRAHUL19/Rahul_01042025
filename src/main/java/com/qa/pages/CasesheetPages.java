...
public class CasesheetPages extends BasePage {
	...
	private By fupButton = By.id("btnFUP");
	public WebElement getfupButton() {
		return getElement(fupButton);

	}
	private By P1refferral = By.id("radbtnadmitafter2");
	public WebElement getP1refferral() {
		return getElement(P1refferral);
