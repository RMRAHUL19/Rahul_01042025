...
public class OrderPacksPage2 extends BasePage {
	
	
	util utilobj = new util();
	boolean InvestigationSearch;
	public OrderPacksPage2(WebDriver driver) {
		super(driver);
	}
	
	
	private By OrderPacks=By.id("ctl00_cphpage_ImgName");
	private By txtOrderPacks=By.id("txtName");
	private By checkselect=By.id("ChkSelect21");
...
/*Investigations*/
    ...
    private By UpdateBtn=By.id("ctl00_cphpage_btnSave");
	...
	public WebElement gettxtOrderPacks() {
		return getElement(txtOrderPacks);
	}
	public WebElement getcheckselect() {
		return getElement(checkselect);
	}
