...
public WebElement getIPMDischargeintimationLink() {
	...
	private By orderpackselection = By.id("19074"); //
	...
	private By cphpage_hyp_0=By.xpath("ctl00_cphpage_hyp_0");
...
public WebElement getRequestTypeDDL() {
	...
	private By BlackOverLay = By.xpath("/html/body/div[1]/form/div[4]/div[2]/div/div/div[2]/div[1]/table/tbody/tr/td/div/table/tbody/tr[2]/td/div/table/tbody/tr[1]/td/div[2]/div[1]");
	                                                   
	public WebElement getBlackOverLay() {
		return getElement(BlackOverLay);
	}
	
	private By txtDate=By.id("ctl00_cphpage_IPWorklistSearch_dlData_ctl00_txtDate");
	public WebElement gettxtDate() {
		return getElement(txtDate);
	}
	
	private By txtdate_CalendarExtender_prevArrow=By.id("ctl00_cphpage_IPWorklistSearch_dlData_ctl00_txtdate_CalendarExtender_prevArrow");
	public WebElement gettxtdate_CalendarExtender_prevArrow() {
		return getElement(txtdate_CalendarExtender_prevArrow);
	}
	private By CalendarExtender_day_0_4=By.id("ctl00_cphpage_IPWorklistSearch_dlData_ctl00_txtdate_CalendarExtender_day_0_4");
	public WebElement getCalendarExtender_day_0_4() {
		return getElement(CalendarExtender_day_0_4);
	}
	
	
	private By ctl01_txtDate=By.id("ctl00_cphpage_IPWorklistSearch_dlData_ctl01_txtDate");
	public WebElement getctl01_txtDate() {
		return getElement(ctl01_txtDate);
	}
	
	private By ctl01_txtdate_CalendarExtender_prevArrow=By.id("ctl00_cphpage_IPWorklistSearch_dlData_ctl01_txtdate_CalendarExtender_prevArrow");
	public WebElement getctl01_txtdate_CalendarExtender_prevArrow() {
		return getElement(ctl01_txtdate_CalendarExtender_prevArrow);
	}
	private By ctl01_txtdate_CalendarExtender_day_0_4=By.id("ctl00_cphpage_IPWorklistSearch_dlData_ctl01_txtdate_CalendarExtender_day_0_4");
