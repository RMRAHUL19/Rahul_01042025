...
public class MATest3  extends CrossBrowser {
    ...
    @Test(priority =12)
       ...
       @Test(priority =13)
   	public void TC_MA_Page_3_7_checkboxes() throws InterruptedException {
       ...
       @Test(priority =14)
   	public void TC_MA_Page_3_7_dropdown() throws InterruptedException {
       ...
       @Test(priority =15)
	public void TC_MA_Page_3_7_entries_float() throws InterruptedException, IOException {
		
		String txt="123471234";
		String decimal = "12347.12341";
		
		MAPage3.gettxtBedOccupancy().sendKeys(decimal);
   		MAPage3.gettxtBedTurnover().sendKeys(decimal);
   		MAPage3.gettxtAverageLengthALOS().sendKeys(txt);
   		MAPage3.gettxtNurseBedRatio().sendKeys(decimal);
		assertEquals(MAPage3.gettxtBedOccupancy().getAttribute("value"), decimal);
		assertEquals(MAPage3.gettxtBedTurnover().getAttribute("value"), decimal);
		assertEquals(MAPage3.gettxtNurseBedRatio().getAttribute("value"), decimal);
	...
	public void TC_MA_Page_3_7_entries_redo() throws InterruptedException, IOException {
   	...
   	String txt="129.47jhdgh'.;][32bqwie bcqiy wbdiqb wdi qiwduqwi dnqwiduqni xetcytvubinompsdcf vygubhinjmrdtfcgv @.";
		...
		assertEquals(MAPage3.gettxtIPDAttendanceRemarks().getAttribute("value"), txt);
		assertEquals(driver.findElement(By.id("ctl00_cphpage_Page3_txtPharmacyRemarks")).getAttribute("value"), txt);
	...
	String txt="12347.12341";
		...
		assertEquals(MAPage3.gettxtDrugExpiredFloatAllopathy().getAttribute("value"), txt);
		assertEquals(MAPage3.gettxtDrugExpiredFloatAyurvedic().getAttribute("value"), txt);
		assertEquals(MAPage3.gettxtDrugExpiredFloatHomeopathy().getAttribute("value"), txt);
	...
	public void TC_MA_Page_3_8_GEM_NONGEM_float_plus_numeric() throws InterruptedException, IOException {
		...
		assertEquals(MAPage3.gettxtNonGemPurchaseDrugs().getAttribute("value"), num);
	...
	public void TC_MA_Page_3_8_LPRCDrugsAmount_float() throws InterruptedException, IOException {
		...
		assertEquals(MAPage3.gettxtLPRCDrugsAmount().getAttribute("value"), txt);
	...
	public void TC_MA_Page_3_8_LPRCDrugsReason_alphanumeric_plus_special_characters() throws InterruptedException, IOException {
		...
		MAPage3.gettxtLPRCDrugsReason().sendKeys(txt);
		assertEquals(MAPage3.gettxtLPRCDrugsReason().getAttribute("value"), txt);
	...
	public void TC_MA_Page_3_8_RCNonRCExpenditure_float() throws InterruptedException, IOException {
		...
		assertEquals(MAPage3.gettxtExpRCDrugAyurveda().getAttribute("value"), txt);
		assertEquals(MAPage3.gettxtExpRCDrugHomeo().getAttribute("value"), txt);
		assertEquals(MAPage3.gettxtExpRCDrugYoga().getAttribute("value"), txt);
		assertEquals(MAPage3.gettxtExpNonRCDrugAyurveda().getAttribute("value"), txt);
		assertEquals(MAPage3.gettxtExpNonRCDrugHomeo().getAttribute("value"), txt);
		assertEquals(MAPage3.gettxtExpNonRCDrugYoga().getAttribute("value"), txt);
	...
	@Test(priority =29)
	public void TC_MA_Page_3_9_ICUHDUNICU_Checkbox() throws InterruptedException {
	...
	@Test(priority =30)
	public void TC_MA_Page_3_9_ICUHDUNICU_Dropdown() throws InterruptedException {
	...
	@Test(priority =31)
	public void TC_MA_Page_3_9_ICUHDUNICU_entries() throws InterruptedException, IOException {
	...
	public void TC_MA_Page_3_8_GemPurchaseDrugs_float() throws InterruptedException, IOException {
		...
		assertEquals(MAPage3.gettxtGemPurchaseDrugs().getAttribute("value"), txt);
	
	}
	
	@Test(priority =38)
	public void TC_MA_Page_3_save_and_next_and_previous() throws InterruptedException {
		...
		try {
			...
			Thread.sleep(1000);
			utilobj.getScreenshot(driver, "blocker issue");
			Thread.sleep(1000);
			...
			driver.findElement(By.id("ctl00_cphpage_btnPrevious")).click();
			MAPage3.gettxtLPRCDrugsReason().sendKeys("129.47jhdgh'.;][32bqwie bcqiy wbdiqb wdi qiwduqwi dnqwiduqni xetcytvubinompsdcf vygubhinjmrdtfcgv @.");
			MAPage3.getbtnNext().click();
			Thread.sleep(2000);
			driver.findElement(By.id("ctl00_cphpage_btnPrevious")).click();
