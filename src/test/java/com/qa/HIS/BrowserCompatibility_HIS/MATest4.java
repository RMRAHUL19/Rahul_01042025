...
public class MATest4  extends CrossBrowser {
	...
	public void TC_MA_004() throws InterruptedException, IOException {
	 ...
	 @Test(priority =7)
		public void TC_MA_remarks_plus_check() throws InterruptedException, IOException {
			...
			assertEquals(MAPage4.gettxtNursingRemarks().getAttribute("value"), txt);
			assertEquals(MAPage4.gettxtParamedicalLabRemarks().getAttribute("value"), txt);
			assertEquals(MAPage4.gettxtParamedicalOTRemarks().getAttribute("value"), txt);
			assertEquals(MAPage4.gettxtParamedicalRadiologyRemarks().getAttribute("value"), txt);
			assertEquals(MAPage4.gettxtParamedicalOthersRemarks().getAttribute("value"), txt);
			assertEquals(MAPage4.gettxtPharmacistRemarks().getAttribute("value"), txt);
			assertEquals(MAPage4.gettxtMinisterialRemarks().getAttribute("value"), txt);
		...
		public void TC_MA_Page4_Sanctioned() throws InterruptedException, IOException {
		 ...
		 @Test(priority =12)
	   	public void TC_MA_Page_4_10_2_doctors_extra_fields() throws InterruptedException {
			...
			@Test(priority =13)
			public void TC_MA_Page4_super_speciality_availability() throws InterruptedException {
				utilobj.selectDropdown(MAPage4.getddlAvailableSuperSpecialfacility(), driver, "Yes", "firefox");
		}
			
			@Test(priority =14)
			public void TC_MA_Page4_super_specialist() throws InterruptedException {
			 ...
			 @Test(priority =15)
			 public void TC_MA_Page_4_10_3_super_specialits_extra_fields() throws InterruptedException {
