...
public class ReportTemplateTest extends CrossBrowser {
	...
	public void TC_Report_Template_Creation_004() throws InterruptedException {
		...
		Thread.sleep(1000);
		wait.until(ExpectedConditions.presenceOfElementLocated(By.id("ctl00_cphpage_ucCommonSearch_hisSearchResultGrid_gdvList_ctl02_chkTemp")));
		Thread.sleep(2000);
...
public void TC_Report_Template_Creation_005() throws InterruptedException {
	...
	RTP.getProcedureSelectButton().click();
	Thread.sleep(2000);
	wait.until(ExpectedConditions.visibilityOf(RTP.getUpdateButton()));
