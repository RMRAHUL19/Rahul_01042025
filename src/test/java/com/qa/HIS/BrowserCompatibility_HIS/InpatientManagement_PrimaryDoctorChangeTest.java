...
public class InpatientManagement_PrimaryDoctorChangeTest extends CrossBrowser {
	...
	@Test(priority = 4)
	public void IPM_Primary_Doctor_Change_TC_3() throws InterruptedException, AWTException {
	...
	@Test(priority = 5)
	public void  IPM_Primary_Doctor_Change_TC_4() throws InterruptedException {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(4));
		Thread.sleep(2000);
