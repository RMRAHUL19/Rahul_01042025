...
public class Registration_ReportTest extends CrossBrowser {
	...
	public void RegistrationReport_TC_1() throws AWTException, InterruptedException {
			...
			Thread.sleep(4000);
			String text = driver.findElement(By.id("ctl00_ctl00_cphpage_cphReport_CalFromDate_day_4_4")).getText();
			System.out.println("the next dayis -" + text);
			Thread.sleep(2000);
			driver.findElement(By.id("ctl00_ctl00_cphpage_cphReport_CalFromDate_day_4_4")).click();
			Thread.sleep(2000);
			String TextOfMessage=null;
			int x=0;
			try {
				TextOfMessage = driver.switchTo().alert().getText();
			} catch (Exception e) {
			...
			assertEquals(x,0,"alert not found");
	...
	public void RegistrationReport_TC_2() throws InterruptedException, AWTException {
		...
		RRP.getDispensary_Report_FO_List_RegistrationDate().click();
		Thread.sleep(4000);
		driver.findElement(By.id("ctl00_ctl00_cphpage_cphReport_CalFromDate_today")).click();
		Thread.sleep(4000);
