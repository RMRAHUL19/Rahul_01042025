...
////		Thread.sleep(3000);
	...
	WebDriverWait wait=new WebDriverWait(driver, Duration.ofSeconds(300));
	wait.until(ExpectedConditions.presenceOfElementLocated(By.id("ctl00_lnkbtnChangeHospital")));
	wait.until(ExpectedConditions.elementToBeClickable(By.id("ctl00_lnkbtnChangeHospital")));
		Thread.sleep(5000);
   		utilobj.JSClick(IPDflowpages.getchange_facility_location_linkLink(), driver);
   		Thread.sleep(3000);
		wait.until(ExpectedConditions.presenceOfElementLocated(By.id("ctl00_cphpage_ddlHospital")));
    ...
    wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("ctl00_cphpage_OPWorklistSearch_btnOK")));
	Thread.sleep(3000);
	utilobj.JSClick(driver.findElement(By.id("ctl00_cphpage_imgOutPatient")), driver);
	Thread.sleep(3000);
	try {
		driver.findElement(By.id("ctl00_cphpage_MyMessageBoxInfo_ButtonOK")).click();
	} catch (Exception e) {
	...
	Thread.sleep(3000);
	wait.until(ExpectedConditions.visibilityOf(IPDflowpages.gettxtDate()));

//	IPDflowpages.gettxtDate().click();
//	IPDflowpages.gettxtdate_CalendarExtender_prevArrow().click();
//	IPDflowpages.getCalendarExtender_day_0_4().click();
//	
//	Thread.sleep(2000);
//	
//	IPDflowpages.getctl01_txtDate().click();
//	IPDflowpages.getctl01_txtdate_CalendarExtender_prevArrow().click();
//	IPDflowpages.getctl01_txtdate_CalendarExtender_day_0_4().click();
//	Thread.sleep(2000);
	driver.findElement(By.id("ctl00_cphpage_IPWorklistSearch_btnOK")).click();
...
//	System.out.println("Number of page"+numberofpage);
	...
	if(driver.findElement(By.id("ctl00_cphpage_btnLast")).isEnabled()==true)
	{
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("ctl00_cphpage_btnLast")));
	driver.findElement(By.id("ctl00_cphpage_btnLast")).click();
	Thread.sleep(2000);
...
String parent3 = driver.getWindowHandle();
	...
	utilobj.ChildWindow(driver);
	Thread.sleep(3000);
	wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/form/div[3]/div/div[2]/div/table/tbody/tr[2]/td[7]/input")));
    utilobj.JSClick(IPDflowpages.getimageWorkListReqDetailPAcheckBox(),driver);
   	...
   	Thread.sleep(3000);
   	utilobj.selectDropdown(IPDflowpages.getimageWorkListReqDetailTP_NOFU_ITEMddl(), driver, "TEST TUBES, THICKNESS: 0.8 -1.0 MM, SIZE 10 X 75 MM",Browser);
   	Thread.sleep(2000);
    ...
    utilobj.JSClick(IPDflowpages.getimageWorkListReqDetailPAcheckBox(),driver);
   	...
   	try {
		wait.until(ExpectedConditions.presenceOfElementLocated(By.id("MyMessageBoxInfo_ButtonOK")));
		utilobj.JSClick(IPDflowpages.getimageWorkListReqDetailTPINFOMESSAGE(),driver);
	} catch (Exception e) {
		e.printStackTrace();
	}
	...
	utilobj.ChildWindow(driver);
	Thread.sleep(3000);
	wait.until(ExpectedConditions.presenceOfElementLocated(By.id("txtEditor_ctl02_ctl00")));
	driver.switchTo().frame("txtEditor_ctl02_ctl00");
	Thread.sleep(3000);
	IPDflowpages.gettxtResultentry().sendKeys(prop.getProperty("resultText"));
	Thread.sleep(3000);
	...
	public void testcaseforInpatientIssues(String Browser) throws InterruptedException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("ctl00_cphpage_imgBtnAdmissionNo")));
		driver.findElement(By.id("ctl00_cphpage_imgBtnAdmissionNo")).click();
		...
		wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.id("ctl00_cphpage_btnOK"))));
		...
		Thread.sleep(3000);
		wait.until(ExpectedConditions.visibilityOf(IPDflowpages.getpatientAdmission_succesokbutton()));
		IPDflowpages.getpatientAdmission_succesokbutton().click();
