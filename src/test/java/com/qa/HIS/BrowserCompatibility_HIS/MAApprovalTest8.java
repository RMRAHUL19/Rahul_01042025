...
public class MAApprovalTest8  extends CrossBrowser {
	...
	public void TC_MA_004() throws InterruptedException, IOException {
		String path=System.getProperty("user.dir")+"\\ExcelTestdata";
			...
			@Test(priority =15)
			public void TC_MA_Page_8_approve_and_print() throws InterruptedException {
				
				
				MAPage8.getbtnNext().click();				
				Thread.sleep(2000);
				utilobj.getScreenshot(driver, "Approved");
				Thread.sleep(2000);
				driver.findElement(By.id("ctl00_cphpage_btnYes1")).click();
				Thread.sleep(1000);
				utilobj.SwitchToChildWindow(driver, "MonthlyAssessmentPrint.aspx");
				Thread.sleep(1000);
				driver.manage().window().maximize();
				Thread.sleep(10000);
				utilobj.getScreenshot(driver, "Print");
