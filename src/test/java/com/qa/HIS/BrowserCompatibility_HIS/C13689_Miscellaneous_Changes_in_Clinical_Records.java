...
public class C13689_Miscellaneous_Changes_in_Clinical_Records extends CrossBrowser {

	public C13689_Miscellaneous_Changes_in_Clinical_Records() {
...
public void doLoginTest() throws IOException {
	...
	@Test(priority = 6)
	public void	ESIC_HIS_App_LocationANDFacility_Selection_Clinical_Records_Dr_Worklist_ESIC_Employee_Esic_Pensioner_Insurance_Number_Search_Icon_Functionality_TC_20() throws InterruptedException {
		WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(5));
		MCICRP.getPopupCloseButton().click();
		Thread.sleep(2000);
		MCICRP.getESIC_Employee_ESIC_Pensioner_Insurance_NoText().sendKeys("11000999");
		Thread.sleep(2000);
		MCICRP.getESIC_Employee_ESIC_Pensioner_Insurance_No_ImageSearchbutton().click();
	...
	public void ESIC_HIS_Clinical_Records_Dr_Worklist_casesheet_add_DiagnosWithoutICDCode_Diagnosis_TC_010(String Browser) throws InterruptedException, AWTException {
    	...
    	Thread.sleep(1000);
    	robot.keyPress(KeyEvent.VK_R);
    	Thread.sleep(1000);//38362002$Dengue fever
	...
	@Test(priority = 9)
	public void ESIC_HIS_Clinical_Records_Clinical_Records_Inpatient_Emergency_Patient_Click_on_Bed_IPD_Case_sheet_Diagnosis_TC_015() throws InterruptedException {
		Thread.sleep(5000);
	...
	@Test(priority = 10)
	public void ESIC_HIS_Clinical_Records_Clinical_Records_Inpatient_Emergency_Patient_Click_on_Bed_IPD_Casesheet_Print_TC_17() throws InterruptedException {
		Thread.sleep(5000);
		MCICRP.getpopupok().click();
