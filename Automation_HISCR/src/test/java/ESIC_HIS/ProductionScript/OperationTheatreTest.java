...
//		Thread.sleep(3000);
	...
	public void dotestforOT_PAC(String Browser) throws InterruptedException {
		...
		utilobj.JSEnterText(operationtheatrepage.getHI_TXTSearch(),driver,"Bone regeneration/repair procedure - as part of a flap operation");
		Thread.sleep(2000);

		utilobj.JSClick(operationtheatrepage.getHI_procedurebutton(), driver);
		wait.until(ExpectedConditions.invisibilityOf(operationtheatrepage.getHI_selectitem()));
		Thread.sleep(2000);
