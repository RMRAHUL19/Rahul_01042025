...
public void Do_testFatchingDetailForESICEmployeeSelf() throws InterruptedException {
	...
	Thread.sleep(2000);
	MISC.getInsuranceTxtBox().sendKeys("170653");
	Thread.sleep(2000);
	MISC.getLiveListLink().click();
	Thread.sleep(2000);
	WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
...
public void Do_TestFatchingDetailForESICPensionerDepandents() throws InterruptedException {
	...
	Thread.sleep(2000);
	WebDriverWait wait=new WebDriverWait(driver, Duration.ofMinutes(1));
	wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.id("ctl00_cphpage_hisLiveListControl_Grdhrms_ctl03_chkHRMSUHID"))));
	driver.findElement(By.id("ctl00_cphpage_hisLiveListControl_Grdhrms_ctl03_chkHRMSUHID")).click();
