...
public class IPDFlowTest extends CrossBrowser{
	...
	@Parameters("browser")
		...
		wait.until(ExpectedConditions.invisibilityOf(IPDflowpages.getBlackoverLay()));
		//wait.until(ExpectedConditions.visibilityOf(IPDflowpages.getpatientAdmission_permanantsameaspresent()));
		Thread.sleep(3000);
		...
		wait.until(ExpectedConditions.invisibilityOf(IPDflowpages.getpatientAdmission_succesokbutton()));
		Thread.sleep(3000);
	...
	public void dotestcaseIPDFlowPagepatientInpatientmanagement(String Browser) throws InterruptedException {
		...
		utilobj.selectDropdown(IPDflowpages.getINpatientmanagementAllotbed_bedName(), driver, "MALE MED BED 004",Browser);
		 Thread.sleep(3000);
		 ...
		 IPDflowpages.getINpatientmanagementAllotbed_saveButton().click();
			 ...
			 utilobj.MoveElement(IPDflowpages.getINpatientmanagementLink(), driver);
				...
				Thread.sleep(3000);
				utilobj.selectDropdown(IPDflowpages.getINpatientmanagementUpdateStatus_bednametxtDDL(), driver, "MALE MED BED 004",Browser);
...
//				prop.getProperty("facilityName"),Browser);
		...
		utilobj.selectDropdown(IPDflowpages.getSelectHospitalLocationDDL(), driver, "ESIC TEST HOSPITAL DL",Browser);
		Thread.sleep(3000);
		utilobj.selectDropdown(IPDflowpages.getSelectFacilityLocationDDL(), driver, prop.getProperty("facilityName"),Browser);
		Thread.sleep(3000);
		utilobj.JSClick(IPDflowpages.getSelectFacilityLocationSubmitButton(), driver);
			Thread.sleep(3000);
	...
	public void testcaseforLaboratory(String Browser) throws InterruptedException {
		...
		utilobj.ChildWindow(driver);
		wait.until(ExpectedConditions.visibilityOf(IPDflowpages.getlaboratory_Requisition_Details_IP_OPSC_checkboxLink()));
		Thread.sleep(2000);
