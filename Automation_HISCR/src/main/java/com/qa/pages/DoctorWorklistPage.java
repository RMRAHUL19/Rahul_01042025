...
boolean checkinformsg;
	...
	private By hisLiveListControlchkUHID = By.id("ctl00_cphpage_hisLiveListControl_gdvInsurance_ctl03_chkUHID");
	...
	//advice
	private By caseSheetAdviceLink = By.id("ctl00_cphpage_trvSectionst17");
